	...
	<div class="row mr-1 ml-1">
		...
		<div class="col-md-4">
			<div class="card h-100">
				<div class="card-header">
					<h1><%=rs.getString("patientName")%></h1>
					<%
						boolean suggested = rs.getBoolean("suggested");
								if (suggested == false) {
									out.println("Not suggested");
								} else {
									out.println("Suggested");
								}
					%>
				</div>
				<div class="card-body">
				...
				<div class="card-footer text-center">
					<a class="btn btn-primary" href="patientDetailsForDoctor.jsp?patientId=<%=rs.getString("patientId")%>">
						Show Details 
					</a>
				</div>
			</div>
