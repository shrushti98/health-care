...
<body id="home" data-spy="scroll">
	...
	<%
		try {
			...
			String patientPayments = "select payment.paymentId, payment.paymentStatus, payment.paymentReceipt, payment.paymentDate, patient.patientId, patient.patientName from payment join patient where payment.patientId = " + patientId + " and patient.patientId = " + patientId;

			rs = stmt.executeQuery(patientPayments);
			if(rs.next() == false ){
	%>
