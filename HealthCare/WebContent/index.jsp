		...
		<div class="container">
			...
			<div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
				<ul class="navbar-nav">
					...
					<li><a class="nav-link" href="adminLogin.jsp">Admin</a></li>
					<li><a class="nav-link" href="patientLoginRegister.jsp">Patient</a></li>
					<li><a class="nav-link" href="doctorLogin.jsp">Doctor</a></li>
